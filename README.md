# 🚀 Temel Web Teknolojileri ve Araçlar Eğitim Kaynakları

Bu depo, temel web teknolojileri ve programlama araçları hakkında eğitim materyallerini içermektedir. Aşağıda her bir dosyanın içeriği ve bağlantıları bulunmaktadır.

## 📚 İçerikler

### 1. **Temel HTML Eğitimi**
   - **Dosya:** [temel-html.html](./temel-html.html)
   - **Açıklama:** HTML'in temel yapısı, etiketler, formlar, tablolar ve semantik elementler hakkında kapsamlı bir rehber.
...
3. **Dosyaları görüntüleyin:**
   - `.html` dosyalarını web tarayıcınızda açın
   - `.docx` dosyasını Microsoft Word veya benzeri bir kelime işlemciyle açın
...
Bu depodaki materyaller eğitim amaçlı olup, açık kaynaklıdır.

---

**⭐️ Bu depoyu beğendiyseniz yıldız vermeyi unutmayın!**

**📧 İletişim:** [Proje Sahibi İsim] - [sakaryadigem@gmail.com] - [sonerpalanci@gmail.com]
